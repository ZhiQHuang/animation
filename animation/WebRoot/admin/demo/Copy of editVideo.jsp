...
<form class="layui-form" action="">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="tname" lay-verify="title" autocomplete="off" placeholder="请输入分类名称" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-input-block">
...
function child(obj){
 layui.use(['form', 'layedit', 'upload'], function(){
        ...
        form.on('submit(demo1)', function(data){
        	console.log(data);
        	var params={"tname":data.field.tname,"tid":obj.tid}
			$.ajax({
	        	url:"editType",
	        	data:params ,
	        	dataType:"text",
        ...
        $("input[name='tname']").attr("placeholder",obj.tname);
