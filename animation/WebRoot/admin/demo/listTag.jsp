...
<div class="my-btn-box">
    <span class="fl">
        ...
        <button type="button" class="layui-btn add-tab" lay-id="1">
	        <a style="color: white;" href="javascript:;" href-url="demo/addTag.jsp">添加标签</a>
	    </button>
...
<!-- 表格 -->
<table class="layui-hide" id="dateTable" lay-filter="table" lay-data="{initSort:{field:'tagid', type:'desc'}}"></table>
    ...
    layui.use(['table', 'form', 'layer', 'vip_table', 'vip_tab'], function () {
        ...
        var tableIns = table.render({
            ...
            , cols: [[                  //标题栏
                ...
                , {field: 'tagid', title: 'ID', width: 200, align: 'center'}
                , {field: 'name', title: '标签名称', width: 500, align: 'center'}
	      ...
	      table.on('tool(table)', function(obj){
	           ...
	           if(obj.event === 'del'){
	              layer.confirm('确认删除吗？', function(index){
	                  $.post("deleteTag",{"tagid":data.tagid},function(msg){
	                      if(msg.code==0){
	                          obj.del();
	                          layer.close(index);
	                      }else{
        ...
        table.on('checkbox(table)', function (obj) {
        	if(obj.checked){
        		checkedArr.push(obj.data.tagid);
...
<script type="text/html" id="barOption">
	<a class="layui-btn layui-btn-mini" lay-event="editTag">修改</a>
