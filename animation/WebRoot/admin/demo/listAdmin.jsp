...
<div class="my-btn-box">
    <span class="fl">
		...
		<button type="button" class="layui-btn add-tab" lay-id="1">
	        <a style="color: white;" href="javascript:;" href-url="demo/addAdmin.jsp">添加普通管理员</a>
	    </button>  
...
<script type="text/javascript">
    ...
    layui.use(['table', 'form', 'layer', 'vip_table', 'vip_tab'], function () {
        ...
        var tableIns = table.render({
            ...
            , cols: [[                  //标题栏
                ...
                , {field: 'adminid', title: 'ID', width: 200, align: 'center'}
                , {field: 'adminname', title: '管理员名称', width: 300, align: 'center'}
                , {field: 'time', title: '上次上线时间', width: 300, align: 'center'}
	      ...
	      table.on('tool(table)', function(obj){
	           ...
	           if(obj.event === 'del'){
	              layer.confirm('确认删除吗？', function(index){
	                  $.post("../deleteAdminuser",{"adminid":data.adminid},function(msg){
	                      if(msg.code==0){
	                          obj.del();
	                          layer.close(index);
	                      }else{
        ...
        table.on('checkbox(table)', function (obj) {
        	if(obj.checked){
        		checkedArr.push(obj.data.adminid);
        ...
        $('.batchDel').on('click', function(){
        	if(checkedArr.length>0){
	        	layer.confirm('确认删除吗？', function(index){
	        		var params={"adminIds":checkedArr}
						$.ajax({
				        	url:"../batchDelAdminuser",
				        	data:params ,
				        	dataType:"text",
				        	type:"POST",
				        	traditional: true,
   ...
   //修改分类
   function editAdminuser(data,obj) {
	    layer.open({
		    type: 2,
		    title: '修改管理员信息',
		    shadeClose: false,
