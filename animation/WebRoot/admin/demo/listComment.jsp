    ...
    layui.use(['table', 'form', 'layer', 'vip_table', 'vip_tab'], function () {
        ...
        var tableIns = table.render({
            ...
            , cols: [[                  //标题栏
                ...
                , {field: 'cid', title: 'ID', width: 200, align: 'center'}
                , {field: 'username', title: '用户名', width: 250, align: 'center'}
                , {field: 'content', title: '内容', width: 450, align: 'center'}
                , {field: 'time', title: '评论时间', width: 250, align: 'center'}
	      ...
	      table.on('tool(table)', function(obj){
	           ...
	           if(obj.event === 'del'){
	              layer.confirm('确认删除吗？', function(index){
	                  $.post("deleteComment",{"cid":data.cid},function(msg){
	                      if(msg.code==0){
	                          obj.del();
	                          layer.close(index);
	                      }else{
