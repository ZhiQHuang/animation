...
<div class="my-btn-box" >
    <span class="fl">
		...
		<button type="button" class="layui-btn add-tab" lay-id="1">
	        <a style="color: white;" href="javascript:;" href-url="demo/addVideo.jsp">添加视频</a>
	    </button>        
    ...
    layui.use(['table', 'form', 'layer', 'vip_table', 'vip_tab'], function () {
        ...
        var tableIns = table.render({
            ...
            , cols: [[                  //标题栏
                ...
                , {field: 'vid', title: 'ID', width: 100, align: 'center'}
                , {field: 'title', title: '视频名称', width: 350}
                , {field: 'src', title:'链接', width: 320, align: 'center' }
                , {field: 'date', title: '发表日期', width: 150, align: 'center'}
                , {field: 'tname', title: '所属分类', width: 100, align: 'center'}
                , {field: 'vfrom', title: '来源', width: 100, align: 'center'}
	      ...
	      table.on('tool(table)', function(obj){
	           ...
	           if(obj.event === 'del'){
	              layer.confirm('确认删除吗？', function(index){
	                  $.post("deleteVideo",{"vid":data.vid},function(msg){
	                      if(msg.code==0){
	                          obj.del();
	                          layer.close(index);
	                      }else{
...
<script type="text/html" id="barOption">
	<a class="layui-btn layui-btn-mini" lay-event="editVideo">修改</a>
