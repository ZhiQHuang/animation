...
<!-- //banner -->
<!-- single -->
	<div class="single" id="nInfoContainer">
		<div class="container">
				...
				<div class="col-md-8 blog-left">
					<div class="blog-left-grid">
						...
						<div class="blog-leftr">
							<img :src="newsInfo.pictures" alt=" " class="img-responsive" width="400px"  height="auto"/>
						...
						<div class="admin-text">
								<h5>Written By {{newsInfo.author}}</h5>
...
<script type="text/javascript">
  var pinfovue=new Vue({
     ...
     methods:{},
     created:function(){
    		var params={"newsId":getQueryString("newsId")};
    		this.$http.post("admin/demo/getNewsById",params,{emulateJSON:true}).then(
     		function(res){
